...
export class RegistrationComponent implements OnInit {
  ...
  stateList: Array<any> = [
    { name: "Abia State", locals: ["Aba South", "Arochukwu", "Bende", "Ikwuano", "Isiala Ngwa North", "Ugwunagbo", "Ukwa East", "Ukwa West", "Umuahia North", "Umuahia South", "Umu Nneochi"] },
    { name: "Anambra State", locals: ["Anambra East", "Anambra West", "Anaocha", "Awka North", "Awka South", "Ayamelum", "Dunukofia", "Ekwusigo", "Idemili North", "Idemili South", "Ihiala", "Njikoka", "Nnewi North", "Nnewi South", "Ogbaru", "Onitsha North", "Onitsha South", "Orumba North", "Orumba South", "Oyi"] },
    {
      name: "Delta State", locals: ["Aniocha North", "Aniocha South", "Ika North East", "Ika South", "Ndokwa East", "Ndokwa West", "Oshimili North", "Oshimili South", "Ukwuani"]
    },
    { name: "Ebonyi State", locals: ["Afikpo North", "Afikpo South", "Ebonyi", "Ezza North", "Ezza South", "Ikwo", "Ishielu", "Ivo", "Izzi", "Ohaozara", "Ohaukwu", "Onicha"] },
    { name: "Enugu State", locals: ["Awgu", "Enugu East", "Enugu North", "Enugu South", "Ezeagu", "Igbo Etiti", "Igbo Eze North", "Igbo Eze South", "Isi Uzo", "Nkanu East", "Nkanu West", "Nsukka", "Oji River", "Udenu", "Udi", "Uzo Uwani"] },
    { name: "Imo State", locals: ["Ahiazu Mbaise", "Ehime Mbano", "Ezinihitte", "Ideato North", "Ideato South", "Ihitte Uboma", "Ikeduru", "Isiala Mbano", "Isu", "Mbaitoli", "Ngor Okpala", "Njaba", "Nkwerre", "Nwangele", "Obowo", "Oguta", "Ohaji Egbema", "Okigwe", "Orlu", "Orsu", "Oru East", "Oru West", "Owerri Municipal", "Owerri North", "Owerri West", "Unuimo"] },
    { name: "Rivers State", locals: ["Ahoada East", "Ahoada West", "Akuku-Toru", "Andoni", "Asari-Toru", "Bonny", "Degema", "Eleme", "Emuoha", "Etche", "Gokana", "Ikwerre", "Khana", "Obio Akpor", "Ogba Egbema Ndoni", "Ogu Bolo", "Okrika", "Omuma", "Opobo Nkoro", "Oyigbo", "Port Harcourt", "Tai"] },
  ]
  ...
  stateOfResidenceList: Array<any> = [
    {
      "name": "Abia State",
      "locals": [
        "Aba South",
  ...
  constructor(private ref: ChangeDetectorRef, private userService: UserService, private router: Router, private toastr: ToastrService) { }
  ...
  changeState(state) {
    this.lga = this.stateList.find(con => con.name == state).locals;
  }

  changeStateOfResidenceList(state) {
    this.locals = this.stateOfResidenceList.find(con => con.name == state).locals;
  }

  changeCountry(state: String) {
    this.state = this.countryList.find(con => con.country == state).states;
  }
  ...
  prepRaveOptions = () => {
    this.raveOptions = {
      ...
      currency: this.register.country_of_residence === 'Nigeria' ? "NGN" : "USD",
      country: this.register.country_of_residence === 'Nigeria' ? "NG" : "US",
      customer_firstname: this.register.first_name || '',
      customer_lastname: this.register.last_name || '',
      customer_phone: this.register.phone_number || '',
      custom_title: 'ohanaeze',
      custom_description: 'ohanaeze',
      custom_logo: 'https://www.ohanaezendigboworldwide.org/wp-content/uploads/2019/11/WhatsApp_Image_2019-11-16_at_2-removebg-preview-1.png',
      redirect_url: '',
      meta: {}
    }
